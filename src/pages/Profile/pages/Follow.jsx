...
export default function Follow() {
    ...
    return (
        <Layout>
            ...
            <LayoutContent>
                {isFollowingList
                    ? followingList.map((user) => <FollowUser key={user._id} user={user} setIsButtonClick={setIsButtonClick} />)
                    : followerList.map((user) => <FollowUser key={user._id} user={user} setIsButtonClick={setIsButtonClick} />)}
            </LayoutContent>
            <NavBar />
        </Layout>
    );
